// packages/engine/src must stay importable by Vite and Metro: no Node-only APIs. This test
// strips comments and string literals first, so prose never trips it, then matches syntax.
